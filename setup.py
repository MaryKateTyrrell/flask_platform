...
#
#     from dummyapp import metadata
#
# However, when we do this, we also import `dummyapp/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'dummyapp_cli = dummyapp.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'dummyapp_gui = dummyapp.gui:entry_point'
        # ]
    }
)
